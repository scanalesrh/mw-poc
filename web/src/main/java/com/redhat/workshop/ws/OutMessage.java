...
public class OutMessage  implements java.io.Serializable {
    ...
    /**
     * Gets the out value for this OutMessage.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this OutMessage.
     * 
     * @param out
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.redhat.workshop:services:1.0", "outMessage"));
